...
pub(crate) mod infovis {
    ...
    pub(crate) const SIGNAL_OVERLAY_LOW: Color = Color::hsla(200., 0.5, 0., OVERLAY_ALPHA);
    /// The color used to indicate that the signal strength is high.
    pub(crate) const SIGNAL_OVERLAY_HIGH: Color = Color::hsla(300., 1., 0.5, OVERLAY_ALPHA);
}
